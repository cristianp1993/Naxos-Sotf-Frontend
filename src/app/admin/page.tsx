        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
            ...
            <div className="flex-1">
              <p className="text-white font-medium">Nueva venta registrada</p>
              <p className="text-purple-300 text-sm">Hace 5 minutos</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
            ...
            <div className="flex-1">
              <p className="text-white font-medium">Stock actualizado</p>
              <p className="text-purple-300 text-sm">Hace 15 minutos</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
            ...
            <div className="flex-1">
              <p className="text-white font-medium">Nuevo pedido creado</p>
              <p className="text-purple-300 text-sm">Hace 30 minutos</p>
            </div>
          </div>
        </div>
      </div>
